...
.breadcrumb{font-size:13px;color:var(--ink-soft);margin-bottom:18px;letter-spacing:.01em}
...
.cta-big .lb{font-size:13px;font-weight:700;letter-spacing:.02em}
...
.mapa-embed{border:0;width:100%;height:380px;display:block}
...
.faq summary::before{content:"?";flex-shrink:0;width:24px;height:24px;border-radius:50%;background:var(--c-coral-soft);color:var(--c-coral-dk);display:inline-flex;align-items:center;justify-content:center;font-weight:700;font-size:13px}
...
footer{background:#fff;border-top:1px solid var(--line);padding:30px 24px;text-align:center;color:var(--ink-soft);font-size:13px;margin-top:60px}
      ...
      <div style="background:#fff;border-radius:24px;padding:28px;max-width:440px;width:100%;box-shadow:0 20px 50px rgba(0,0,0,.3)" onclick="event.stopPropagation()">
        <div style="display:flex;align-items:start;justify-content:space-between;margin-bottom:14px">
          <div>
            ...
            <div style="font-size:13px;color:#6E6989">${{nome}}</div>
          </div>
        ...
        <div style="margin-bottom:14px">
          <label style="display:block;font-weight:700;color:#2C2356;font-size:13px;margin-bottom:6px">Para que idades sabes que há vaga?</label>
        ...
        <div style="margin-bottom:14px">
          <label style="display:block;font-weight:700;color:#2C2356;font-size:13px;margin-bottom:6px">Como soubeste? <small style="color:#6E6989;font-weight:500">(opcional)</small></label>
          <textarea id="_v-notas-pai" maxlength="280" rows="2" placeholder="Ex.: Liguei hoje e disseram-me que têm vaga para Setembro" style="width:100%;background:#FFF6EE;border:1.5px solid #F1E6D9;border-radius:12px;padding:9px 12px;font-family:inherit;font-size:13px;color:#2C2356;resize:vertical"></textarea>
        </div>
