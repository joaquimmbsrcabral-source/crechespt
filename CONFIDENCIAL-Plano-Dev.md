...
*Julho 2026 · Interno · v2 (alinhado com orçamento equipa + roadmap Pro) · "Fiabilidade primeiro, receita a seguir, features depois"*
...
Manter a plataforma rápida, segura e no ar — e construir as duas frentes do Ano 1: o **Pro** (a receita que sustenta o projeto) e a **Fase 3 do painel** (candidaturas/mensagens).
...
### M2-3 — ⭐ Creches.app Pro MVP (a entrega que valida o CLT)
...
### M4-6 — Fase 3 do painel + Pro fase 2
...
- [ ] Pro: comunicação com pais (templates, convites de visita c/ calendário; SMS avaliar custo)
...
| **Pro** | espec + Stripe sandbox | MVP em beta c/ 5 creches | **50 early adopters a pagar/trial** |
| Incidentes >1h | 0 | 0 | 0 |
